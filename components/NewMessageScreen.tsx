        ...
        const newChatData = {
            ...
            participantInfo: {
                [user1.uid]: {
                    ...
                    handle: user1.handle || '',
                    profileBadgeUrl: user1.profileBadgeUrl || null,
                    nameplateStatusUrl: user1.nameplateStatusUrl || null,
                    isPremium: user1.isPremium || false,
                },
                [user2.uid]: {
                    displayName: user2.displayName || 'Unknown User',
                    photoURL: user2.photoURL || null,
                    handle: user2.handle || '',
                    profileBadgeUrl: user2.profileBadgeUrl || null,
                    nameplateStatusUrl: user2.nameplateStatusUrl || null,
                    isPremium: user2.isPremium || false,
                }
            },
            lastMessage: '',
